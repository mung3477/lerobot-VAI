...
CUDA_VISIBLE_DEVICES=1 python src/lerobot/scripts/lerobot_train.py \
  --dataset.repo_id="[DP_wrist_10_10_0.0_0.0/v3.0/v-1.000-1.000_num1]" \
  --dataset.root="/home/kwonmc/jiyun/lerobot-VAI/dataset_git/libero_goal_no_noops_island_1_lerobot" \
  --policy.type="smolvla" \
