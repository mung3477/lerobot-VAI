...
CUDA_VISIBLE_DEVICES=0 python src/lerobot/scripts/lerobot_train.py \
  --dataset.repo_id=[v-1.000-1.000_num1,v-1.000-1.000_num2,v-1.000-1.000_num4] \
  --dataset.root="/data1/local/shortcut-learning-in-grps/dataset_git/libero_10_no_noops_island_1_lerobot/vla_wrist_10_10_0.0_0.0/libero_10_v3.0" \
  --policy.type="smolvla" \
  ...
  --num_workers=16 \
  --job_name="smolvla_vanilla_spatial_except_2_4_angle_from_0" \
